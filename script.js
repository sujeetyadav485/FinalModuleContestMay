...
async function getIp() {
  ipAddr = await fetch("https://ipinfo.io/47.15.38.155/json?token=c05a34b7ad1ede")
...
async function getPostalData(pin){
 return  await fetch(`https://ipinfo.io/47.15.38.155/json?token=c05a34b7ad1ede${pin}`).then((response)=>response.json());
}
